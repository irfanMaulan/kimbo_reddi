...
<div class="card">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-3">Showing <strong>{{ 1 + (($page - 1)  * 20) }}</strong> to <strong>{{ $total_record > '20' ? 20 + (($page - 1)  * 20) : $total_record  }}</strong> of <strong>{{ $total_record }}</strong> entries</div>
